...
induction Hsub; subst; intros; subst; try solve by inversion...
...
Case "Sub_r_depth".
  ...
  induction H1.
  SCase "Forall2_nil".
    inversion Hlen. apply length_0_nil in H3; subst. inversion H2.
  SCase "Forall2_cons".
...
Case "Sub_r_perm".
  ...
  inversion Heqright_rec; subst. clear Heqright_rec.
  exists T. split...
  apply permutation_in with (i, T) (combine li' lT') (combine li lT) in H...
Admitted.